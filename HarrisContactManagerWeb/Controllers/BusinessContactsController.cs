...
using HarrisContactManagerWeb.Data;
using HarrisContactManagerWeb.Models;

namespace HarrisContactManagerWeb.Controllers
{
    public class BusinessContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BusinessContactID,BusinessFname,BusinessLname,BusinessCompany,BusinessPosition,BusinessTel,BusinessEmail,BusinessAddr,BusinessCity,BusinessPostcode")] BusinessContact businessContact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BusinessContactID,BusinessFname,BusinessLname,BusinessCompany,BusinessPosition,BusinessTel,BusinessEmail,BusinessAddr,BusinessCity,BusinessPostcode")] BusinessContact businessContact)
        {
