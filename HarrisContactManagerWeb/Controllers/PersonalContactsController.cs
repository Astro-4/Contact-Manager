...
namespace HarrisContactManagerWeb.Controllers
{
    public class PersonalContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PersonalContactID,PersonalFname,PersonalLname,PersonalDepartment,PersonalTel,PersonalEmail,PersonalAddr,PersonalCity,PersonalPostcode")] PersonalContact personalContact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonalContactID,PersonalFname,PersonalLname,PersonalDepartment,PersonalTel,PersonalEmail,PersonalAddr,PersonalCity,PersonalPostcode")] PersonalContact personalContact)
        {
